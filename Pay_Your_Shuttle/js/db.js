const DB = (function () {
  ...
  // ─── Members ───
  function addMember(m)    { return reqToPromise(getStore('members','readwrite').add(m)); }
  ...
  function updateMember(m) { return reqToPromise(getStore('members','readwrite').put(m)); }
  function deleteMember(id){ return reqToPromise(getStore('members','readwrite').delete(id)); }

  // ─── Contributions ───
  function addContribution(c)    { return reqToPromise(getStore('contributions','readwrite').add(c)); }
  ...
  function updateContribution(c) { return reqToPromise(getStore('contributions','readwrite').put(c)); }
  function deleteContribution(id){ return reqToPromise(getStore('contributions','readwrite').delete(id)); }
  ...
  // ─── Payments ───
  function addPayment(p)    { return reqToPromise(getStore('payments','readwrite').add(p)); }
  ...
  function updatePayment(p) { return reqToPromise(getStore('payments','readwrite').put(p)); }
  ...
  // ─── Expenses ───
  function addExpense(ex)    { return reqToPromise(getStore('expenses','readwrite').add(ex)); }
  ...
  function updateExpense(ex) { return reqToPromise(getStore('expenses','readwrite').put(ex)); }
  function deleteExpense(id) { return reqToPromise(getStore('expenses','readwrite').delete(id)); }
  ...
  // ─── Monthly Fee Records ───
  function addMonthlyFeeRecord(r)    { return reqToPromise(getStore('monthly_fee_records','readwrite').add(r)); }
  ...
  function updateMonthlyFeeRecord(r) { return reqToPromise(getStore('monthly_fee_records','readwrite').put(r)); }
  function deleteMonthlyFeeRecord(id){ return reqToPromise(getStore('monthly_fee_records','readwrite').delete(id)); }
  ...
  // ─── Guest Sessions ───
  function addGuestSession(s)    { return reqToPromise(getStore('guest_sessions','readwrite').add(s)); }
  ...
  function updateGuestSession(s) { return reqToPromise(getStore('guest_sessions','readwrite').put(s)); }
  function deleteGuestSession(id){ return reqToPromise(getStore('guest_sessions','readwrite').delete(id)); }
